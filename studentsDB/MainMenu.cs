...
namespace studentsDB
{
    public partial class MainMenu : Form
    {
        ...
        SqlConnection sqlCon = new SqlConnection(@"Data Source=(LocalDB)\v11.0;AttachDbFilename='E:\диплом\Новая папка\studentsDB\Database3.mdf';Integrated Security=True");
